...
import cndjp.qicoo.domain.dao.event.toEvent
import cndjp.qicoo.domain.dao.linked_user.LinkedUser
import cndjp.qicoo.domain.dao.linked_user.NewLinkedUser
import cndjp.qicoo.domain.dao.linked_user.toLinkedUser
...
import cndjp.qicoo.domain.dao.reply.NewReply
import cndjp.qicoo.domain.dao.reply.Reply
import cndjp.qicoo.domain.dao.reply.toReply
import cndjp.qicoo.domain.dao.todo_question.NewTodoQuestion
import cndjp.qicoo.domain.dao.todo_question.toTodoQuestion
import cndjp.qicoo.domain.dao.unlinked_user.NewUnlinkedUser
import cndjp.qicoo.domain.dao.unlinked_user.UnlinkedUser
import cndjp.qicoo.domain.dao.unlinked_user.toUnlinkedUser
import cndjp.qicoo.domain.dao.user.NewUser
import cndjp.qicoo.domain.dao.user.User
import cndjp.qicoo.domain.dao.user.toUser

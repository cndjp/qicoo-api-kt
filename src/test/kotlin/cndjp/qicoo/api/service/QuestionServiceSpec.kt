...
object QuestionServiceSpec: Spek({
    ...
    group("QuestionServiceのmockテスト") {
        test("getAll()でのテスト") {
            ...
            assertEquals(qMock.q1date.toDateTimeJstForMySQL(), dto1.list[0].created)
            assertEquals(qMock.q1date.toDateTimeJstForMySQL(), dto1.list[0].updated)
            ...
            assertEquals(qMock.q2date.toDateTimeJstForMySQL(), dto1.list[1].created)
            assertEquals(qMock.q2date.toDateTimeJstForMySQL(), dto1.list[1].updated)
            ...
            assertEquals(qMock.q3date.toDateTimeJstForMySQL(), dto2.list[0].created)
            assertEquals(qMock.q3date.toDateTimeJstForMySQL(), dto2.list[0].updated)
            ...
            assertEquals(qMock.q4date.toDateTimeJstForMySQL(), dto2.list[1].created)
            assertEquals(qMock.q4date.toDateTimeJstForMySQL(), dto2.list[1].updated)
            ...
            assertEquals(qMock.q5date.toDateTimeJstForMySQL(), dto2.list[2].created)
            assertEquals(qMock.q5date.toDateTimeJstForMySQL(), dto2.list[2].updated)

    ...
    group("QuestionAggrRepositoryのテスト") {
        test("findAll()のテスト") {
            transaction {
                ...
                assertEquals(q1date, list1.list[0].created)
                assertEquals(q1date, list1.list[0].updated)
                ...
                assertEquals(q2date, list1.list[1].created)
                assertEquals(q2date, list1.list[1].updated)
                ...
                assertEquals(q5date, list2.list[0].created)
                assertEquals(q5date, list2.list[0].updated)
                ...
                assertEquals(q3date, list3.list[0].created)
                assertEquals(q3date, list3.list[0].updated)
            }
        }
        test("findByIds()のテスト") {
            val result1 = questionAggrRepositoryImpl.findByIds(listOf(2, 3, 4))
            val list1 = result1.list.sortedByDescending { it.created }
            ...
            assertEquals(q2date, list1[0].created)
            assertEquals(q2date, list1[0].updated)
            ...
            assertEquals(q3date, list1[1].created)
            assertEquals(q3date, list1[1].updated)
            ...
            assertEquals(q4date, list1[2].created)
            assertEquals(q4date, list1[2].updated)
            val result2 = questionAggrRepositoryImpl.findByIds(listOf(1, 4))
            val list2 = result2.list.sortedByDescending { it.created }
            ...
            assertEquals(q1date, list2[0].created)
            assertEquals(q1date, list2[0].updated)
            ...
            assertEquals(q4date, list2[1].created)
            assertEquals(q4date, list2[1].updated)
        }
        test("insert()のテスト") {
